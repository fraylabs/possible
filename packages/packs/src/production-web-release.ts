...
export const productionWebReleasePack: OutcomePack = {
  ...
  outputs: [
    ...
    "Verified preview smoke report",
    "Approved production deployment or deployment no-go completion report",
  ...
  guardrails: [
    ...
    "Automated execution supports the reviewed OpenAI Sites and Vercel adapters only. For another provider, produce the provider-neutral preflight and stop with a completion report that records the provider as unsupported.",
  ...
  verification: [
    ...
    "Finish with a completion report listing the candidate, target, approval evidence, deployment identity and URL, rollback point, passed, failed, skipped, and unproven checks—or the exact no-go reason.",
  ],
};
