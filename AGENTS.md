...
Possible compiles existing skills into seven outcome packs: Hardware Launch, Software Launch, Open-Source Release, Playable Web Game, Web App Operations, Working Web App, and Production Web Release.
