...
assert.match(buildWeek, /Frozen submission implementation: 1c1b3df65ba69b0a0bf76a61e86319a73fdcf637/);
assert.match(buildWeek, /Current submission state: frozen/);
