...
assert.match(docs, /npx @fraylabs\/possible@0\.1\.8 init/);
...
for (const phrase of ["Agent skill", "Execution prompt", "Outcome Pack", "$possible", "dozens of coordinated tasks", "npx @fraylabs/possible@0.1.8 init"]) {
