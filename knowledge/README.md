...
directional graph edges. All such links must resolve to another canonical page.
Outgoing links power the atlas card's level-down group, and backlinks power its
level-up group. Contributors never author a second edge list.
